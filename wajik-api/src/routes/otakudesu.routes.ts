...
otakudesuRouter.get("/browse/filter", serverCache(10), otakudesuController.getAdvancedBrowseFilter);
...
otakudesuRouter.get("/resolve-stream", serverCache(10), otakudesuController.resolveStream);
otakudesuRouter.get("/stream-proxy", otakudesuController.getStreamProxy);
otakudesuRouter.get("/iframe-proxy", otakudesuController.iframeProxy);
otakudesuRouter.get("/redirect-proxy", otakudesuController.getRedirectUrl);
otakudesuRouter.get("/aggregate-stream/:episodeId", serverCache(10), otakudesuController.getAggregateStream);
